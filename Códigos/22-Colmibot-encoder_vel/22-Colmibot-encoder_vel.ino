...
volatile unsigned CurrentTime_R = 0;
volatile unsigned PreviousTime_R = 0;
volatile unsigned DeltaTime_R = 0;
double freq_R = 0;
double W_R = 0;
double V_R = 0;
...
void setup() {
  ...
  Serial.begin(115200);
  SerialBT.begin("Colmillo"); //Bluetooth device name
...
void encoderR(){
    ...
    DeltaTime_R = CurrentTime_R - PreviousTime_R;
    PreviousTime_R = CurrentTime_R;
    freq_R = (1000) / (double) DeltaTime_R;
